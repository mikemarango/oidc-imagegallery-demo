...
namespace ImageGallery.Data
{
    public class GalleryContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Image>().Property(i => i.Title).HasMaxLength(150).IsRequired();
            modelBuilder.Entity<Image>().Property(i => i.OwnerId).HasMaxLength(50).IsRequired();
            modelBuilder.Entity<Image>().Property(i => i.FileName).HasMaxLength(200).IsRequired();
